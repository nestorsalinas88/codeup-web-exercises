...
function sayHello(name) {
    console.log(name + "welcome to your console!");
}
...
console.log('Is this the #2 ' + isTwo(random));
...
function calculatedTip(percent, total) {
    ...
    var percentTotal = prompt("Amount of tip in percent ");
    var amountToTip = (percentTotal / 100) * totalBill;
    return alert("Are you sure you'd like to tip " + amountToTip + "?");
}
